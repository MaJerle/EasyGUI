...
uint16_t TM_BUFFER_Write(TM_BUFFER_t* Buffer, const uint8_t* Data, uint16_t count) {
	uint8_t i = 0;
...
int16_t TM_BUFFER_Find(TM_BUFFER_t* Buffer, const uint8_t* Data, uint16_t Size) {
...
uint16_t TM_BUFFER_WriteString(TM_BUFFER_t* Buffer, const char* buff) {
